...
async function main() {
  ...
  const usdf = await contractAt("USDF", "0xE14F46Ee1e23B68003bCED6D85465455a309dffF")
  ...
  await sendTxn(usdf.approve(router.address, maxUint256), "usdf.approve(router)")
