...
async function getArbValues() {
  ...
  return { glp, flpManager, stakedGlpTracker, feeGlpTracker }
}
...
async function main() {
  const { glp, flpManager, stakedGlpTracker, feeGlpTracker } = await getValues()
  ...
  // await deployContract("GlpBalance", [flpManager.address, stakedGlpTracker.address])
}
