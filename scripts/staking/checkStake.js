...
async function main() {
  ...
  console.log("stakedFxdxTracker.claimable", (await stakedFxdxTracker.claimable(account)).toString())
  console.log("bonusFxdxTracker.claimable", (await bonusFxdxTracker.claimable(account)).toString())
  console.log("feeFxdxTracker.claimable", (await feeFxdxTracker.claimable(account)).toString())
}
