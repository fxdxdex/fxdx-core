...
describe("FlpManager", function () {
  ...
  beforeEach(async () => {
    ...
    await glp.setMinter(flpManager.address, true)
  ...
  it("inits", async () => {
    ...
    expect(await flpManager.usdg()).eq(usdg.address)
    expect(await flpManager.glp()).eq(glp.address)
  ...
  it("addLiquidity, removeLiquidity", async () => {
    ...
    await expect(flpManager.connect(user0).addLiquidity(
      ...
      expandDecimals(101, 18),
      expandDecimals(101, 18)
    )).to.be.revertedWith("FlpManager: insufficient USDG output")
    ...
    expect(await usdg.balanceOf(flpManager.address)).eq(0)
    ...
    expect(await usdg.balanceOf(flpManager.address)).eq("99700000000000000000") // 99.7
    ...
    expect(await flpManager.getAumInUsdg(true)).eq("99700000000000000000")
    expect(await flpManager.getAumInUsdg(false)).eq("99700000000000000000")
    ...
    expect(await usdg.balanceOf(flpManager.address)).eq("398800000000000000000") // 398.8
    ...
    expect(await flpManager.getAumInUsdg(true)).eq("498500000000000000000")
    expect(await flpManager.getAumInUsdg(false)).eq("398800000000000000000")
    ...
    expect(await flpManager.getAumInUsdg(true)).eq("598200000000000000000") // 598.2
    expect(await flpManager.getAumInUsdg(false)).eq("498500000000000000000") // 498.5
    ...
    await expect(flpManager.connect(user2).addLiquidity(
      ...
      expandDecimals(399, 18)
    )).to.be.revertedWith("FlpManager: insufficient GLP output")
    ...
    expect(await usdg.balanceOf(flpManager.address)).eq("997000000000000000000") // 997
    expect(await glp.balanceOf(user0.address)).eq("99700000000000000000") // 99.7
    expect(await glp.balanceOf(user1.address)).eq("299100000000000000000") // 299.1
    ...
    expect(await flpManager.getAumInUsdg(true)).eq("1196400000000000000000") // 1196.4
    expect(await flpManager.getAumInUsdg(false)).eq("1096700000000000000000") // 1096.7
    ...
    expect(await flpManager.getAumInUsdg(true)).eq("1059312500000000000000") // 1059.3125
    expect(await flpManager.getAumInUsdg(false)).eq("967230000000000000000") // 967.23
    ...
    expect(await flpManager.getAumInUsdg(true)).eq("644785357142857143000") // 644.785357142857143
    expect(await flpManager.getAumInUsdg(false)).eq("635608285714285714400") // 635.6082857142857144
    ...
    await usdg.addVault(flpManager.address)
  ...
  it("addLiquidityForAccount, removeLiquidityForAccount", async () => {
    ...
    expect(await glp.totalSupply()).eq("398800000000000000000")
    expect(await flpManager.lastAddedAt(user1.address)).eq(blockTime)
    expect(await flpManager.getAumInUsdg(true)).eq("398800000000000000000")
