...
interface IRewardRouter {
    ...
    function mintAndStakeFlp(address _token, uint256 _amount, uint256 _minUsdf, uint256 _minFlp) external returns (uint256);
    function mintAndStakeFlpETH(uint256 _minUsdf, uint256 _minFlp) external payable returns (uint256);
    ...
    function unstakeAndRedeemFlp(address _tokenOut, uint256 _flpAmount, uint256 _minOut, address _receiver) external returns (uint256);
    function unstakeAndRedeemFlpETH(uint256 _flpAmount, uint256 _minOut, address payable _receiver) external returns (uint256);
